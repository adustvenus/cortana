...
TOOL_DEFS = {
    ...
    "sms_send": _schema("sms_send",
                        ...
                        "confirm=true after they agree. ANY clear affirmative counts - yes, yeah, "
                        "yep, sure, ok, do it, go ahead, send it, send it now, please do, "
                        "confirm - and you should accept the natural ones rather than holding "
                        "out for a magic word. What is NOT a yes: silence, a question, a change "
                        "to the wording, or anything you are unsure about. When in doubt ask "
                        "again rather than sending. The recipient and body must "
